...
#
# Generated by export_simulation on Thu Mar 28 17:25:31 +0700 2019
#
################################################################################
...
'-reset_run' switch to the './extra_mem_0.sh' script.

./extra_mem_0.sh -reset_run
...
./extra_mem_0.sh -noclean_files

For more information on the script, please type './extra_mem_0.sh -help'.
